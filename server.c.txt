...
void *TitleWriter(void *sock) {
    ...
    while(1) {
        ...
        sprintf(string, "%c]0;Skids Conntected: %d | Telnets Scanned: %d  | VerifiedUser's: %d%c", '\033', BotsConnected(), TELFound, OperatorsConnected, '\007');
...
void *BotWorker(void *sock) {
    ...
    while(j!=i-1) {
        ...
        if(send(datafd, "\x1b[31mSora: \x1b[30m ", 22, MSG_NOSIGNAL) == -1) goto end;
		...
		sprintf(ascii_banner_line2, "\x1b[1;36m██╔════╝██╔═══██╗██╔══██╗██╔══██╗	\r\n");
		sprintf(ascii_banner_line3, "\x1b[1;37m███████╗██║   ██║██████╔╝███████║	\r\n"); 
		sprintf(ascii_banner_line4, "\x1b[1;36m╚════██║██║   ██║██╔══██╗██╔══██║	\r\n"); 
